...
export default function Project({ project }: ProjectProps) {
  ...
  return (
    <Link href={link || "#"} passHref>
      <div className="project-card rounded-lg bg-slate-700 flex flex-col min-h-full flex-grow cursor-pointer">
        <Image
          src={image}
          alt={name}
        ...
        <div className="p-4 flex-col flex flex-grow">
          ...
          <div
            className={`grid ${link ? 'grid-cols-2' : 'grid-cols-1'} gap-2 mt-auto`}
          >
            {/* 
            {link && (
              <Button
